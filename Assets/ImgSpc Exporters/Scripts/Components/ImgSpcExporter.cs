...
namespace ImgSpc.Exporters
{
    public class ImgSpcExporter : MonoBehaviour
    {
        ...
        public void Export ()
        {
            ...
            // Check platform and set destination directory accordingly
            ...
            {
                destinationDirectory = System.Environment.GetFolderPath(System.Environment.SpecialFolder.UserProfile) + "/Downloads/";
            }
                print("destinationDirectory is " + destinationDirectory);

            if (!System.IO.Path.IsPathRooted (DestinationFilename)) {
                DestinationFilename = destinationDirectory + "/" + DestinationFilename;
            ...
            if (!temp.Equals (method.Extension)) {
                ...
                print("DestinationFilename is " + DestinationFilename);
